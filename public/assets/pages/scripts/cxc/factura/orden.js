...
function agregar_insumo() {
    ...
    tarifa = (detv_precioU *0.12);
    tarifa1 =(detv_precioU+tarifa);
        ...
        $("#tblInsumos").append(`
                <tr id="tr-${detv_producto}">
                    <td>
                        ...
                        <input type="hidden" name="tarifa1[]" value="${tarifa1}"/>
                    ...
                    <td><button type="button" class="btn-danger" onclick="eliminar_insumo(${detv_producto},
                     ${detv_precioU}, ${iva1},${iva},${totald}, ${totalq}, ${total},${totaliva},${totalsiva}, ${tarifa1}, )">
