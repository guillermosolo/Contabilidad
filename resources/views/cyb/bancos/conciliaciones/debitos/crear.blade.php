                                            ...
                                            <div class="col-sm-12 col-lg-4">
                                                <select name="trab_cuentabancaria" class="form-control select2" id="inputcuentabancaria" required>
                                                    ...
                                                    @foreach($cuentasbancariass as $cuentasbancarias)
                                                        <option value="{{$cuentasbancarias->ctab_id}}"{{old('trab_cuentabancaria')==$cuentasbancarias->ctab_id ? 'selected':''}}>{{$cuentasbancarias->ctab_id}} - {{$cuentasbancarias->ctab_numero}} - {{$cuentasbancarias->Empresa->emp_siglas}} - {{$cuentasbancarias->Banco->ban_siglas}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
